...
export default function ColorizeQueue({ readerJobStatus, logs }) {
  return (
    <div className="page-stack">
      <ProgressStrip
        ...
        message={
          readerJobStatus?.running
            ? `当前任务：${readerJobStatus?.book_id || "-"} / 第 ${readerJobStatus?.current_page || "-"} 页`
            : "当前没有阅读器上色任务。"
        }
        stages={stages}
      ...
      <div className="two-column-grid">
        <MangaCard title="当前任务" subtitle="阅读器上色队列的实时状态">
          <ul className="info-list">
            ...
            <li>书籍：{readerJobStatus?.book_id || "-"}</li>
          ...
          <div className="gallery-status-badges">
            ...
            <StatusBadge tone="warn">停止任务 Coming soon</StatusBadge>
          </div>
        </MangaCard>
      ...
      <LogPanel title="reader_colorize.log" content={logs?.readerLog} emptyText="还没有阅读器上色日志。" />
    </div>
  );
}
