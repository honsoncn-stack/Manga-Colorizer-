    ...
    <div className="page-stack">
      <MangaCard title="使用说明" subtitle="导入本地漫画，阅读时按页上色，并导出完整 PDF。">
        <ul className="info-list">
          ...
          <li>可以上色当前页、后续几页或整本漫画；已有彩色缓存的页面会自动跳过。</li>
          <li>生成的彩色页会保存在本地书库，不会上传到云端。</li>
          <li>需要分享时，可以导出完整 PDF：已上色页使用彩色结果，未上色页自动用黑白原图补齐。</li>
          <li>
            GitHub 开源项目：
            <a href="https://github.com/honsoncn-stack/Manga-Colorizer-and-Reader" target="_blank" rel="noreferrer">
              https://github.com/honsoncn-stack/Manga-Colorizer-and-Reader
            </a>
          </li>
